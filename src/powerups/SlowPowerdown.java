...
/**
 * Powerup which looks like a blue lightning bolt
 *
 */
public class SlowPowerdown extends MovableEntity
{
	 ...
	 */
	public SlowPowerdown()
	{
		sprite = new Sprite("/res/sprites/SlowDownPowerUp.png", 96, 96);
	 ...
	 */
	public SlowPowerdown(int x, int y){
		sprite = new Sprite("/res/sprites/SlowDownPowerUp.png", 96, 96);
		this.x = x;
		this.y = y;
		hitbox = new Hitbox();
